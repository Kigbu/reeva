...
const AlertBoxAndroid = () => {
  ...
  return (
    ...
    >
      <Modal
        animationType="none"
        // transparent={type === 'refError' ? false : true}
        transparent={true}
        ...
        <View style={styles.centeredView}>
          <View style={styles.promptView}>
            <View style={styles.promptImgView}>
              ...
              {alertVariants.INFO ? (
                <InfoCircle variant="Bulk" color="blue" size={h(50)} />
              ) : (
                <InfoCircle variant="Bulk" color="red" size={h(50)} />
              )}
            </View>
            <AppText
              style={{
...
export default AlertBoxAndroid;
